...
load_us_cities_demo = GoogleCloudStorageToBigQueryOperator(
    ...
    bucket = BUCKET,
    source_objects = ['{BUCKET}/cities/us-cities-demographics.csv'],
    destination_project_dataset_table = f'{PROJECT_ID}:{STAGING_DATASET}.us_cities_demo',
    #schema_object = '{BUCKET}/cities/us_cities_demo.json',
...
load_airports = GoogleCloudStorageToBigQueryOperator(
    ...
    bucket = BUCKET,
    source_objects = ['{BUCKET}/airports/airport-codes_csv.csv'],
...
load_weather = GoogleCloudStorageToBigQueryOperator(
    ...
    bucket = BUCKET,
    source_objects = ['{BUCKET}/weather/GlobalLandTemperaturesByCity.csv'],
...
load_immigration_data = GoogleCloudStorageToBigQueryOperator(
    ...
    bucket = BUCKET,
    source_objects = ['{BUCKET}/immigration_data/*.parquet'],
...
load_country = GoogleCloudStorageToBigQueryOperator(
    ...
    bucket = BUCKET,
    source_objects = ['{BUCKET}/master_data/I94CIT_I94RES.csv'],
...
load_port = GoogleCloudStorageToBigQueryOperator(
    task_id = 'load_port',
    bucket = BUCKET,
    source_objects = ['{BUCKET}/master_data/I94PORT.csv'],
...
load_state = GoogleCloudStorageToBigQueryOperator(
    task_id = 'load_state',
    bucket = BUCKET,
    source_objects = ['{BUCKET}/master_data/I94ADDR.csv'],
